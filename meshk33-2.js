...
(async () => {
    const userDataDir = "/home/runner/blockman/bloKms33km-2"; // Use the persistent profile
    const extensionPath = "/home/runner/blockman/extKms33km_2"; // Correct extension path
    ...
    await page.goto("https://app.blockmesh.xyz/ui/dashboard", { waitUntil: "load" });

    console.log("Browser started with noKms34km profile. Waiting 10 seconds for login verification...");
    await page.waitForTimeout(10000); // Wait 10 seconds

    if (page.url() === "https://app.blockmesh.xyz/ui/dashboard") {
